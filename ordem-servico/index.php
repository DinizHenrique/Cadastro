...
<head>
    <meta charset="UTF-8" />
    <title>Gerar Ordem de Serviços - UniSom</title>
    ...
    <main>
        ...
        <div class="container-fluid">
            ...
            <div class="card" id="box-cadastro">
                ...
                <form id="cadastro" class="form-inline" action="pesquisa_ordem.php" method="POST">
                    <div class="form-group mb-2">
                        <label for="staticEmail2" class="sr-only">Número da Ordem</label>
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Número da Ordem">
                    </div>
                    <div class="input-group mb-3">
