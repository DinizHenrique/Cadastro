...
<head>
    <meta charset="UTF-8" />
    <title>Pesquisa de Ordem de Serviço - UniSom</title>
...
<body>
    <main>
            ...
            <section class="container">
                ...
                <div class="collapse navbar-collapse" id="movelmenu">
                    <ul class="nav navbar-nav ">
                        ...
                        <li class="nav-item"><a class="nav-link" href="../etiqueta/index.php">Ordem de Serviço</a></li>
        ...
        <div class="container-fluid" style="padding:10px">
            ...
            <?php 
                require_once("../etiqueta/select_etiqueta.php");
            ?>
