...
<head>
    ...
    <script language="JavaScript" type="text/javascript">
        function checkDelete() {
            return confirm('Está certo disso?');
        }
    ...
    <main>
        ...
        <div class="container-fluid" style="padding:10px">
            ...
            <?php if(isset($_POST["nome"])){ 
                    require_once("../pesquisa/busca_nome.php");
                    } elseif(isset(($_POST["nascimento"]))) {  
                    require_once("../pesquisa/busca_nascimento.php");
                    } elseif(isset(($_POST["dia"]))) {  
                    require_once("../pesquisa/busca_relatorio.php");
                    } 
            ?>
