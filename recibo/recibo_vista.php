...
// insercao no banco
    if(isset($_POST["nome"])) {
          ...
          require_once("../recibo/pdf/dados_vista.php");
        
        
       
        $inserir     = "INSERT INTO recibo ";
        $inserir    .= "(nome, clienteID, data_recibo, referente, cheque_bool, parcelas, valor_total, valor_ext ";
        
        
        if(isset($_POST["cheque_bool"])){
