<div class="form-row" id="formrow">
    <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" name="nome" value="<?php echo $row_recibo['nome'] ?> " />
    </div>
    ...
    <div class="form-group col-md-2">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" step="0.01" class="form-control" name="valor_total" id="valor_total" value="<?php echo $row_recibo["valor_total"] ?>" />
        </div>
