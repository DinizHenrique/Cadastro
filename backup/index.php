...
<head>
    <meta charset="UTF-8" />
    <title>Backup de Dados - UniSom</title>
    ...
    <main>
            ...
            <section class="container">
                ...
                <div class="collapse navbar-collapse" id="movelmenu">
                    <ul class="nav navbar-nav ">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="../backup/index.php">Backup</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="card" id="box-cadastro">
                ...
                <form id="cadastro" class="form-inline" action="backup.php?salvar" method="POST">
                    <div class="form-group mb-2">
                        <label for="staticEmail2" class="sr-only">Backup</label>
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Backup">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <input class="btn btn-primary" type="submit" id="button-addon1" value="Salvar">
                        </div>
                    </div>
                </form>
            ...
            <div class="card" id="box-cadastro">
                ...
                <form id="cadastro" class="form-inline" enctype="multipart/form-data" action="restore.php?restaurar" method="POST">
                    <div class="form-group mb-2">
                        <label for="staticEmail2" class="sr-only">Restaurar</label>
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Restauração">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <input type="file" id="backup_file" name="backup_file" />
                            <input class="btn btn-primary" type="submit" id="backup_file" value="Inserir">
                        </div>
                    </div>
                </form>
